"""
Django settings for quotes_coins project.
...
SECRET_KEY = '8u@cc+i&ohk@=1ogni$b!df#p+190g0uxbqssghd5@f)fp8tuf'
...
ROOT_URLCONF = 'quotes_coins.urls'
...
WSGI_APPLICATION = 'quotes_coins.wsgi.application'
